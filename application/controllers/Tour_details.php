...
class Tour_details extends CI_Controller
{
	...
	public function updatePhotos(){
		...
		$detailImage="_detailImage.".pathinfo($_FILES['photos']['name'],PATHINFO_EXTENSION);
		...
		public function editAttractions($itinraryId){
			$this->load->model("itinrary_model");
			$result=$this->itinrary_model->editAttractions($itinraryId);
			//var_dump($result);
