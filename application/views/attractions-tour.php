                ...
                <?php foreach ($tour_list as $key => $tourdata) { ?>
                  <tr id="tour<?php echo $tourdata["id"]; ?>">
                    ...
                    <td class="right-align tour-btn">
                      <a data-tour-id="<?php echo $tourdata['id']; ?>"  class="btn-floating waves-effect waves-light  tour-attraction-edit-btn"><i class="material-icons edit-icon">mode_edit</i></a>
...
<!-- Modal Structure -->
  <div id="attractionsModal" class="modal">
    <div class="modal-content">
      <?php $this->load->view("attractions-dashboard",array("allAttractions"=>$allAttractions,"allTour"=>$allTour)); ?>
    </div>
